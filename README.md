...
Finally, there's the optional file "GIF and other locations", which visualizes our scheduled mobility model in GIFs and has the option of 
running it any other location known to Open Street Map.
